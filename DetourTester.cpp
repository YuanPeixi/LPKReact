...
int main()
{
    //auto tmp = LoadLibraryA("E:\\LPK.dll");
    //cout << tmp << endl;
    if (!InitSimple("LPK64.dll"))cerr << "Faile to load dll" << endl;
    //SetFlag(1);
    EnableDescendant();
    //if (InjectDLL(GetProcessIdByName(L"explorer.exe"), L"C:\\Users\\HP\\source\\repos\\Detour Test 2\\x64\\Release\\Detour Test 2.dll"))cout << "Inject Success" << endl;
    DWORD pid;
    cout << "pid=";
    cin >> pid;
    if (InjectDLL(pid, L"LPK64.dll"))cout << "Inject Success" << endl;
	return 0;
}
